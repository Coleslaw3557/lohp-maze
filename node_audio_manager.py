...
sim/esphome/make_node_audio.py), and background music streams from the
existing GET /api/audio/<file> endpoint through the media pipeline.
...
class _NodeConn:
    ...
    async def play_announcement(self, url):
        ...
        the music bed, which resumes when the cue ends)."""
        async def call():
