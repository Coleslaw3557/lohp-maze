...
Done: all currently built room boxes in this run have been final-flashed and
labelled.
...
| Room | Date | Notes |
|---|---|---|
| Cop Dodge | 2026-08-23 | first real box; radar + DMX + audio. 2026-08-23 final pass: USB flashed latest flat-mix build to MAC `A4:CB:8F:DF:52:48`, RUT lease/reservation `.62`, ping 3/3, parts-can label printed |
