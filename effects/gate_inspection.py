...
def create_gate_inspection_effect():
    ...
    steps = [
        _step(0.0, 0, 255, 255, 255),
        _step(0.08, 255, 255, 255, 255, 255),   # HALT
        _step(0.5, 255, 255, 255, 255, 200),
        _step(0.9, 120, *AMBER),
        ...
        _step(3.2, 255, 255, 255, 255, 180),
        _step(3.34, 120, *AMBER),
        _step(3.9, 170, *AMBER),
        _step(4.6, 90, *AMBER),
        _step(5.06, 110, *AMBER),
        _step(5.1, 255, 255, 255, 255, 180),
    ...
    for t in (7.0, 8.0):
        ...
        steps.append(_step(t, 255, *STAMP, w=220))
        steps.append(_step(round(t + 0.15, 2), 255, *STAMP, w=160))
    ...
    steps.append(_step(11.5, 220, *GREEN, w=60))
